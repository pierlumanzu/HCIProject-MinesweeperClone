...
class ButtonModel(QObject):#Button Model.
    ...
    def __init__(self, X, Y, isMine, **kwargs):
        ...
        self._X = X                                     #This variable indicates the position on the horizontal axis of the grid.
        self._Y = Y                                     #This variable indicates the position on the vertical axis of the grid.
